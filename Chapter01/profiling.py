...
def visualize(simulator):
    ...
    _ = animation.FuncAnimation(
        fig, animate, init_func=init, blit=True, interval=10, cache_frame_data=False
    )
    plt.show()
...
def test_visualize():
    particles = [
        ...
        Particle(0.0, -0.5, -1),
        Particle(-0.1, -0.1, +3),
        Particle(0.1, -0.7, -2.3),
        Particle(0.4, -0.4, +1.4),
    ]
